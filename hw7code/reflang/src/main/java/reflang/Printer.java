...
public class Printer {
	...
	public static class Formatter implements AST.Visitor<String> {
		...
		public String visit(AST.RefExp e, Env env) {	// New for reflang
			String result = "(ref ";
			result += e.value_exp().accept(this, env);
			return result + ")";
		}

		public String visit(AST.DerefExp e, Env env) {	// New for reflang
			String result = "(deref ";
			result += e.loc_exp().accept(this, env);
			return result + ")";
		}

		public String visit(AST.AssignExp e, Env env) {	// New for reflang
			String result = "(set! ";
		...
		public String visit(AST.FreeExp e, Env env) {	// New for reflang
			String result = "(free ";
			result += e.value_exp().accept(this, env);
			return result + ")";
		}
